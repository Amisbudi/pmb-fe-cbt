...
function ModalGrouping({ isOpen, setIsOpen, reloadData, setReloadData, detail, setDetail }) {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    if (detail?.id) {
      await axios.patch(`${import.meta.env.REACT_APP_API_BASE_URL}/groupquestions/${detail?.id}`, data, {
        headers: {
      ...
      await axios.post('${import.meta.env.REACT_APP_API_BASE_URL}/groupquestions', data, {
        headers: {
          "api-key": "b4621b89b8b68387",
        },
      }).then(() => {
  ...
  const packageQuestionData = async () => {
    ...
    await axios.get('${import.meta.env.REACT_APP_API_BASE_URL}/packagequestions', {
      headers: {
        "api-key": "b4621b89b8b68387",
      },
    }).then(({data : {data}}) => {
