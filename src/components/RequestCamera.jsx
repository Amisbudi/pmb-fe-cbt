...
const RequestCamera = () => {
  ...
  const getData = async (page = 1) => {
    setLoading(true);
    await axios
      .get(`${import.meta.env.REACT_APP_API_BASE_URL}/packagequestionusers/requestcamera?page=${page}`, {
        headers: {
  ...
  const handleCameraUpdate = async (e) => {
    ...
    await axios
      .get(
        `${import.meta.env.REACT_APP_API_BASE_URL}/packagequestionusers/camera/${dataId}`,
        {
          headers: {
            "api-key": "b4621b89b8b68387",
          },
